...
function MainApp() {
  ...
  const fetchMentors = useCallback(async () => {
    ...
    console.log('🔍 fetchMentors called:', { 
      mentorTypeFilter, 
      searchTerm, 
    ...
    try {
      ...
      console.log('📥 API response:', { 
        ...
        mentorType: data.mentor_type_filter,
        aiCount: data.ai_count,
        humanCount: data.human_count
      });
      
      if (response.ok) {
        console.log('✅ Setting filtered mentors:', data.results?.length || 0);
        ...
        <div className="mb-8 space-y-4">
          <div className="flex gap-4 items-center flex-wrap">
            ...
            <div className="flex bg-gray-100 rounded-lg p-1">
              <button
                onClick={() => {
                  console.log('🤖 AI Mentors clicked, current filter:', mentorTypeFilter);
              ...
              <button
                onClick={() => {
                  console.log('👥 Human Mentors clicked, current filter:', mentorTypeFilter);
              ...
              <button
                onClick={() => {
                  console.log('🌟 All Mentors clicked, current filter:', mentorTypeFilter);
