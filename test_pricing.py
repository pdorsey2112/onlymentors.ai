...
async def test_pricing_validation():
    async with aiohttp.ClientSession() as session:
        ...
        async with session.post('https://mentor-marketplace.preview.emergentagent.com/api/creators/signup', json=creator_data) as response:
            if response.status == 200:
                ...
                async with session.post('https://mentor-marketplace.preview.emergentagent.com/api/creator/content/upload', 
