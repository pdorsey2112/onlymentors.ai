...
class OAuthConfig:
    def __init__(self):
        ...
        self.google_redirect_uri = os.getenv("GOOGLE_REDIRECT_URI", "https://enterprise-coach.preview.emergentagent.com")
        
        # Facebook OAuth Configuration
        self.facebook_app_id = os.getenv("FACEBOOK_APP_ID")
        self.facebook_app_secret = os.getenv("FACEBOOK_APP_SECRET")
        self.facebook_redirect_uri = os.getenv("FACEBOOK_REDIRECT_URI", "https://enterprise-coach.preview.emergentagent.com")
...
async def get_facebook_user_info(access_token: str) -> FacebookUserInfo:
    ...
    try:
        ...
        async with httpx.AsyncClient() as client:
            ...
            # Handle email not provided case - leave it as None for optional handling
            if "email" not in user_data:
                print(f"Warning: No email permission from Facebook for user ID: {user_data.get('id')}")
