...
class OAuthConfig:
    def __init__(self):
        ...
        self.google_redirect_uri = os.getenv("GOOGLE_REDIRECT_URI", "https://multi-tenant-ai.preview.emergentagent.com")
        
        # Facebook OAuth Configuration
        self.facebook_app_id = os.getenv("FACEBOOK_APP_ID")
        self.facebook_app_secret = os.getenv("FACEBOOK_APP_SECRET")
        self.facebook_redirect_uri = os.getenv("FACEBOOK_REDIRECT_URI", "https://multi-tenant-ai.preview.emergentagent.com")
