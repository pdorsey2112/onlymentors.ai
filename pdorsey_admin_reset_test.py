...
7. Verify link format: https://mentor-marketplace.preview.emergentagent.com/reset-password?token=xxx&type=user
"""
...
class PaulDorseyPasswordResetTest:
    ...
    def display_expected_console_output(self):
        ...
        print(f"   🔗 https://mentor-marketplace.preview.emergentagent.com/reset-password?token=<SECURE_TOKEN>&type=user")
        print(f"   ")
        ...
        print(f"   Base URL: https://mentor-marketplace.preview.emergentagent.com/reset-password")
    ...
    def verify_reset_link_format(self):
        ...
        expected_base = "https://mentor-marketplace.preview.emergentagent.com/reset-password"
    ...
    def run_complete_test(self):
        ...
        print(f"   • Full Name: {self.test_name}")
        print(f"   • Admin Reason: {self.reset_reason}")
        print(f"   • Reset Link: https://mentor-marketplace.preview.emergentagent.com/reset-password?token=xxx&type=user")
